...
# ## Instantaneous size change, sym migration (PSCMIGs)


pts_1 = [200,220,240]

def sizeM(params, ns, pts):
	nuP1, nuR1, T1, nuP2, nuR2, T2, mS = params
	"""
	2-populations, instantaneous size change with ongoing symmetrical gene flow.
	...
	phi = dadi.Integration.two_pops(phi,xx,T1,nu1=nuP1, nu2=nuR1, m12=mS, m21=mS)
	phi = dadi.Integration.two_pops(phi,xx,T2,nu1=nuP2, nu2=nuR2, m12=mS, m21=mS)
...
upper_bound = [100, 100, 50, 100, 100, 50, 100] 
lower_bound = [1e-4,1e-4,1e-4,1e-4, 1e-4, 1e-4, 0.1]
p0 = array([0.5,0.5,0.05,0.5,0.5, 0.05, 5])
...
matplotlib.pyplot.savefig("M12_MigSizeChange.pdf")
