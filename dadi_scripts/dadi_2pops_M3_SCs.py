...
# # Secondary Contact, symmetrical migration (SCs)



pts_1 = [200,220,240]

def SCsym(params, ns, pts):
	nuP, nuR, T1, T2, mS = params
	"""
	2-populations, secondary contact with symmetrical gene flow.
	...
	T2:   Divergence time since migration
	mS:   Symmetrical migration
	...
	phi = dadi.Integration.two_pops(phi,xx,T1,nu1=nuP, nu2=nuR, m12=0, m21=0)
	phi = dadi.Integration.two_pops(phi,xx,T2,nu1=nuP, nu2=nuR, m12=mS, m21=mS)
...
upper_bound = [100, 100, 10, 10, 100] 
lower_bound = [1e-4,1e-4,1e-5,1e-5, 0.1]
p0 = array([0.05,0.05,0.015,0.015, 40])
...
matplotlib.pyplot.savefig("M3_trueSCsym.pdf")
