...
# ### Ongoing symmetrical migration, M2


pts_1 = [200,220,240]

def sym_mig(params, ns, pts):
	nuP, nuR, T1, mS = params
	"""
	2-populations, ongoing symmetrical gene flow.
	...
	phi = dadi.Integration.two_pops(phi,xx,T1,nu1=nuP, nu2=nuR, m12=mS, m21=mS)
...
upper_bound = [100, 100, 10,  100] 
lower_bound = [1e-3,1e-3,1e-3, 0.1]
p0 = array([0.05,0.05,0.015, 40])
...
matplotlib.pyplot.savefig("M2_symMIG.pdf")
